...
public class MessagesTest {
    ...
    static Stream<Arguments> messageTestCases() {
        return Stream.of(
            ...
            Arguments.of("ERROR_FILE_IS_ODD", "The file your trying to read has an odd number of lines. Make it pair."),
    ...
    static Stream<Arguments> propertyTestCases() {
        return Stream.of(
            Arguments.of("env", "dev"),
            Arguments.of("server.grid.rows.number", "7")
        );
    }
